                    ...
                    <div class="top-event__event top-event__event-full">
                        <a href="<?= Url::to(['articles/view', 'slug' => $headnews[0]->slug]); ?>" title="">
                            ...
                            <div class="top-event__event-text">
                                <?php /* <h4><?= $headnews[0]->cat->title ?></h4> */ ?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-md-8 gb-column gb-column__big">
                ...
                <div class="news-group">
                    <div class="news-group__header news-group__header__orange-border">
                        <h2>
                            <?= Html::a($cate1->title, ['articles/cat', 'slug' => $cate1->slug]) ?>
                        </h2>
                ...
                <div class="news-group">
                    <div class="news-group__header news-group__header__green-border">
                        <h2><?= Html::a($cate2->title, ['articles/cat', 'slug' => $cate2->slug]) ?></h2>
                        <div class="news-group__header__buttons-container">
                ...
                <div class="news-group">
                    <div class="news-group__header news-group__header__red-border">
                        <h2><?= Html::a($cate3->title, ['articles/cat', 'slug' => $cate3->slug]) ?></h2>
                        <div class="news-group__header__buttons-container">
                ...
                <div class="news-group">
                    <div class="news-group__header news-group__header__blue-border">
                        <h2><?= Html::a($cate5->title, ['articles/cat', 'slug' => $cate5->slug]) ?></h2>
                        <div class="news-group__header__buttons-container">
                ...
                <div class="news-group">
                    <div class="news-group__header news-group__header__cyan-border">
                        <h2><?= Html::a($cate6->title, ['articles/cat', 'slug' => $cate6->slug]) ?></h2>
                        <div class="news-group__header__buttons-container">
                    ...
                    <div class="news-group__content">
                        <div class="news-group__container__half-big">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="home-news-item__container col-xs-12 col-sm-6">
                                        <?= Html::a(Html::img($pack6[0]->thumb(359, 176)), ['articles/view', 'slug' => $pack6[0]->slug]) ?>
                                        <h3><strong><?= $pack6[0]->title ?></strong></h3>
                                        <span><?= date('d/m/Y', $pack6[0]->time) ?></span>
                                    </div>
                                    <div class="home-news-item__container col-xs-12 col-sm-6">
                                         <?= Html::a(Html::img($pack6[1]->thumb(359, 176)), ['articles/view', 'slug' => $pack6[1]->slug]) ?>
                                        <h3><strong><?= $pack6[1]->title ?></strong></h3>
                                        <span><?= date('d/m/Y', $pack6[1]->time) ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="news-group__container__small">
                            <div class="container-fluid">
                                <div class="row">
                                    <a href="<?= Url::to(['articles/view', 'slug' => $pack6[2]->slug]); ?>" title="" class="home-news-item__container home-news-item__item__small col-xs-12 col-sm-6">
                                        <div class="col-xs-4">
                                            <?= Html::img($pack6[2]->thumb(105, 70)) ?>
                                        </div>
                                        <div class="col-xs-8">
                                            <strong><?= $pack6[2]->title ?></strong>
                                        </div>
                                    </a>
                                    <a href="<?= Url::to(['articles/view', 'slug' => $pack6[3]->slug]); ?>" title="" class="home-news-item__container home-news-item__item__small col-xs-12 col-sm-6">
                                        <div class="col-xs-4">
                                            <?= Html::img($pack6[3]->thumb(105, 70)) ?>
                                        </div>
                                        <div class="col-xs-8">
                                            <strong><?= $pack6[3]->title ?></strong>
                                        </div>
                                    </a>
                                </div>
                            </div>
            ...
            <div class="col-xs-12 col-md-4 gb-column gb-column__small">
                <?= ArticleFeatures::widget(['type' => 'lastest', 'limit' => 8, 'title' => 'Tin mới']) ?>
